...
impl Token {
    ...
    pub async fn move_asset(
        ...
        to_subaaccount: Option<[u8; 32]>,
    ) -> bool {
        let transfer_arg = TransferArg {
            from_subaccount,
            to: Account {
                owner: ic_cdk::id(),
                subaccount: to_subaaccount,
            },
...
impl BoundedStorable for StakeDetails {
...
pub fn _percentageNat(x: u64, value: Nat) -> Nat {
    return (Nat::from(x as u64) * value) / Nat::from(100 * _ONE_PERCENT as u128);
}
